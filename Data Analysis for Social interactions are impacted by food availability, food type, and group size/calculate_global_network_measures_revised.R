# this script gets global network data from the network edgelists in the folder 'network data' 
...
# write.table(merged_df, file = "All_global_df_uniform_thresh.csv") 